...
//                       children: [
//                         Expanded(child: Container(padding: EdgeInsets.only(left: 20,),child: Column(mainAxisSize: MainAxisSize.min,crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
//                           Text(data['songname'],style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
//                           Text(data['caption'],style: TextStyle(fontSize: 15,color: Colors.white),),
//                           Row(
//                             children: [
//                               const Icon(Icons.music_note,size: 15,color: Colors.white,),
//                               Text(data['username'],style: TextStyle(fontSize: 15,color: Colors.white,fontWeight: FontWeight.bold),),
//                             ],
//                           )
//                         ],
//                         )
...
//                                     children: [
//                                       InkWell(
//                                         onTap: ()=>videoController.like(data['id']),
